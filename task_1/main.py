...
def main():
    ...
    DataExporter.export_rooms_with_student_count(db_manager, args.format)
    DataExporter.export_lowest_average_age_rooms(db_manager, args.format)
    DataExporter.export_rooms_with_largest_age_difference(db_manager, args.format)
    DataExporter.export_rooms_with_mixed_gender_students(db_manager, args.format)
